import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{t}from"./react-BZJXY1be.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{a as r,d as i,f as a,m as o,s}from"./form-BKC3PGp_.js";import{a as c,c as l}from"./data-CyEcoex9.js";import{n as u,t as d}from"./SurfaceWheel-DYVepzD3.js";function f({finding:e,onClose:t,onSave:n}){let[o,l]=(0,p.useState)(``),[u,f]=(0,p.useState)([]),[h,g]=(0,p.useState)(``);return(0,p.useEffect)(()=>{e&&(l(e.provider),f(e.surfaces),g(e.notes))},[e]),e?(0,m.jsx)(s,{title:`Edit Finding`,onClose:t,width:`max-w-[480px]`,footer:(0,m.jsx)(r,{onCancel:t,onSave:()=>{n({provider:o,surfaces:u,notes:h}),t()}}),children:(0,m.jsxs)(`div`,{className:`flex flex-col gap-5`,children:[(0,m.jsxs)(`div`,{className:`rounded-md border border-line bg-surface-subtle px-3 py-2.5`,children:[(0,m.jsx)(`p`,{className:`text-xs font-extrabold text-ink`,children:e.area}),(0,m.jsx)(`p`,{className:`text-xs text-ink-muted`,children:e.condition})]}),(0,m.jsx)(i,{label:`Provider`,required:!0,options:c,value:o,onChange:l}),e.tooth!==null&&(0,m.jsxs)(`div`,{className:`flex w-full flex-col items-center gap-2`,children:[(0,m.jsx)(`span`,{className:`w-full text-xs font-semibold text-ink-muted`,children:`Surface`}),(0,m.jsx)(d,{value:u,onChange:f,size:180})]}),(0,m.jsx)(a,{label:`Notes`,placeholder:`Document questions, answers, clarifications, or additional notes`,value:h,onChange:g})]})}):null}var p,m;function h(){return(h=e((()=>{p=t(),o(),u(),l(),m=n(),f.__docgenInfo={description:``,methods:[],displayName:`EditProcedureModal`,props:{finding:{required:!0,tsType:{name:`union`,raw:`Finding | null`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string
  area: string
  condition: string
  descriptor: string
