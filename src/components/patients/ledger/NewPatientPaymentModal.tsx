...
/* Figma 4582:29545 (Single Method) y 4582:29862 (Multiple Methods): el mismo
   modal, el "+" agrega otra fila de Amount/Payment method/Check/Bank-Branch
   -un pago partido en más de un método-. Check y Bank/Branch sólo importan
   con "Check payment": se ocultan con otro método, a diferencia del frame
   que los deja siempre visibles pero vacíos. */
...
export function NewPatientPaymentModal({
