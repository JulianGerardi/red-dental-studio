...
export function NewProcedureModal({
  ...
  const footer = step === 1 ? (
    ...
    <>
      <button type="button" onClick={() => setStep(step === 3 ? 2 : 1)} className="flex h-9 items-center gap-1.5 rounded-md border border-[#e4e4e7] bg-white px-6 text-[13px] font-medium whitespace-nowrap shadow-[0_1px_2px_0_rgb(0_0_0/0.05)] hover:bg-[#fafafa]">
